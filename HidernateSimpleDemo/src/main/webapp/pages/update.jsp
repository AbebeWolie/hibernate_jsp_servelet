        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
            	<%
            		...
            		List<Product> prod = (List<Product>)request.getSession().getAttribute("product");
            		for(Product pro:prod){
            		if(pro != null && pro.getId() == id){
            			
            	%>
                <form action="/HidernateSimpleDemo/UpdateProduct" class="form-horizontal" method="post">
